...
public class PojoHerOkuAppReqBody {
    ...
    public PojoHerOkuAppReqBody(String firstname, String lastname, int totalprice, boolean depositpaid, PojoHerOkuAppBookingdates bookingdates, String additionalneeds) {
        this.firstname = firstname;
        this.lastname = lastname;
        this.totalprice = totalprice;
        this.depositpaid = depositpaid;
